...
Answer: 
1. getElementById: It finds elements by their id. Can contain only one id.
3. getElementsByClassName: It finds all the similar class name, and can contain multiple class name.
4. querySelector : Finds element using CSS selectors. Can contain ( #id), (.class) and many more. Return 1 element which matches first. 
5. querySelectorAll: Finds element using CSS  slectors but return all, NodeList static types.
